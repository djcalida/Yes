...
public class HomeJButton extends JButton {
    private Shape shape;
    private Color defaultColor = new Color(19, 112, 204);

    public HomeJButton(String text) {
        super(text);
